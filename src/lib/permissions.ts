export type CompanyRole = 'proprietario' | 'administrador' | 'gerente' | 'comercial' | 'operacao' | 'financeiro' | 'visualizador'
export type Module = 'comercial' | 'operacao' | 'financeiro' | 'fiscal' | 'configuracoes' | 'equipe'

export const ROLE_LABELS: Record<CompanyRole,string>={proprietario:'Proprietário',administrador:'Administrador',gerente:'Gerente',comercial:'Comercial',operacao:'Operação',financeiro:'Financeiro',visualizador:'Visualizador'}
const managers:CompanyRole[]=['proprietario','administrador','gerente']
const access:Record<Module,CompanyRole[]>={
 comercial:[...managers,'comercial','visualizador'],
 operacao:[...managers,'comercial','operacao','visualizador'],
 financeiro:[...managers,'financeiro'],
 fiscal:[...managers,'financeiro'],
 configuracoes:['proprietario','administrador'],
 equipe:['proprietario','administrador'],
}
